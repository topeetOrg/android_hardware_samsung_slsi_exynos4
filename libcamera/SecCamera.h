...
//jmq.TC4
#ifdef BOARD_USE_S5K3H2
#define TC4_USING_S5K3H2
#endif
#define FRONT_CAM MT9D115  // 2 M
#ifdef TC4_USING_S5K3H2
#define BACK_CAM S5K3H2      // 8 M
#else
#define BACK_CAM S5K4ECGX  // 5 M
#endif
...
/////////////jmq.add for TC4
//BACK 8M
#define S5K3H2_PREVIEW_WIDTH             640
#define S5K3H2_PREVIEW_HEIGHT            480
#define S5K3H2_SNAPSHOT_WIDTH            3248
#define S5K3H2_SNAPSHOT_HEIGHT           2436
#define S5K3H2_THUMBNAIL_WIDTH           320
#define S5K3H2_THUMBNAIL_HEIGHT          240
#define S5K3H2_THUMBNAIL_BPP             16
#define S5K3H2_FPS                       30
#define S5K3H2_FOCAL_LENGTH              343 	/* focal length of 3.43mm */
//BACK 5M 
...
#define S5K4ECGX_THUMBNAIL_WIDTH         160
#define S5K4ECGX_THUMBNAIL_HEIGHT        120
#define S5K4ECGX_THUMBNAIL_BPP           16
#define S5K4ECGX_FPS                     30
#define S5K4ECGX_FOCAL_LENGTH            90	/* focal length of 0.9mm */
//FRONT 2M
...
#define MT9D115_FOCAL_LENGTH              90 	/* focal length of 3.43mm */
/////////////
...
public:
    ...
    int             getSnapshotAndJpeg(SecBuffer *yuv_buf,
                                       ...
                                       int *output_size);
    int             getExif(unsigned char *pExifDst, unsigned char *pThumbSrc, int thumbSize, bool bneedCompress);//jmq.change
