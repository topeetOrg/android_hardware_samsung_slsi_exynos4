...
private:
   ...
   unsigned int         mDebugVaddr;
            ...
            bool        getSupportAutoFocus(const char * sensorname);//jmq.add
    ...
    SecCamera           *mSecCamera;
            ...
            bool        mSupportJpegFromSensor;//jmq.Can we get the jpeg from kernel(sensor)		
            bool        mSupportAutoFocusBySensor;//jmq.Can we get the jpeg from kernel(sensor)
