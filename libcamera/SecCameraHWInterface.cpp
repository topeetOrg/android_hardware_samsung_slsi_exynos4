...
keyvaluemap S5K3H2_setting[]={
	...
	{String8(CameraParameters::KEY_SUPPORTED_PREVIEW_SIZES),String8("1280x720,720x480,640x480,320x240,176x144")},
	...
	{String8(CameraParameters::KEY_SUPPORTED_PREVIEW_FPS_RANGE),String8("(15000,30000)")},
	{String8(CameraParameters::KEY_PREVIEW_FPS_RANGE),String8("15000,30000")},
...
#endif
       //Zoom
       #if 0//not support in no-zoom file
...
keyvaluemap MT9D115_setting[]={
	...
	{String8(CameraParameters::KEY_SUPPORTED_VIDEO_SIZES),String8("1280x720,720x480,640x480,176x144")},	
...
status_t CameraHardwareSec::setParameters(const CameraParameters& params)
{
    ...
    if (new_AWB_lock != NULL && mUseInternalISP && mPreviewRunning && old_AWB_lock != NULL) {//jmq.for no AWBL setting
